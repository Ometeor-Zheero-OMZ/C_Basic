...
int main()
{
    ...
    void* is often used as a parameter type or return value type with functions that
    ...
    when you want to access the integer value at the address stored in the void* pointer, you must first cast
    the pointer to type int*
    *********************************************************************************/
